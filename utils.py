...
def load_data():
    ...
    connection_file=join(PROJ_DIR, "datasets", "relation", "NYSE_connections.json")
    tic_wiki_file=join(PROJ_DIR, "datasets", "relation", "NYSE_wiki.csv")
    sel_path_file=join(PROJ_DIR, "datasets", "relation", "selected_wiki_connections.csv")
    valid_company_file = join(PROJ_DIR, "valid_company.txt")
